...
public class BlockByHashApiTest {
  ...
  void shouldGetBlockByNumber() {
    ...
    assertEquals("0xfeb873f6aca9f2db2e728662abdf505d4c1dbe65b8e3d5f58b01dd938e44624b", block.getParentHash());
    assertEquals("0x0000000000000000", block.getNonce());
    assertEquals("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347", block.getSha3Uncles());
    ...
    assertEquals("0xfb69ec9966c51d900568fc74ea7e879cc5686452bf1a8af14c4dab702ba7da32", block.getTransactionsRoot());
    assertEquals("0x7debad48e69d5f746e392e97e246cab4f426a87b958ad2350e8bf80450a56510", block.getStateRoot());
    assertEquals("0x9b3c7b0fd92b1d27ca0e524482f597f74dfd48296edd2216c689d2897e2f5a1c", block.getReceiptsRoot());
    assertEquals("0xDAFEA492D9c6733ae3d56b7Ed1ADB60692c98Bc5", block.getMiner());
    assertEquals("0", block.getDifficulty());
    assertEquals("58750003716598352816469", block.getTotalDifficulty());
    assertEquals("92886", block.getSize());
    assertEquals("0x496c6c756d696e61746520446d6f63726174697a6520447374726962757465", block.getExtraData());
    assertEquals(new BigInteger("30000000"), block.getGasLimit());
    assertEquals(new BigInteger("13971684"), block.getGasUsed());
    assertEquals(135, block.getTransactionCount());
    assertEquals(block.getTransactionCount(), block.getTransactions().size());
    assertTrue(block.getTransactions().stream().allMatch(transaction -> transaction.getInternalTransactions() == null));
  }
  ...
  void shouldGetBlockByNumberWithInternalTx() {
    ...
    assertEquals(135, block.getTransactionCount());
    assertEquals(block.getTransactionCount(), block.getTransactions().size());
    assertTrue(block.getTransactions().stream().anyMatch(transaction -> transaction.getInternalTransactions() != null));
  }
